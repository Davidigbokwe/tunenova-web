        ...
        >
          ...
          >
            ...
            >
              ...
              <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2">1. Share Your Code</h3>
            ...
            >
              ...
              <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2">3. You Earn</h3>
              <p className="text-gray-600 text-sm lg:text-base">
                You earn for every friend who joins.
              </p>
            </motion.div>
