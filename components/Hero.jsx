...
const HeroSection = () => {
  ...
  return (
    <section className="overflow-hidden rounded-3xl mx-2 sm:mx-4 md:mx-8 lg:mx-12 h-auto min-h-[60vh] flex flex-col md:flex-row">
      ...
      {/* Right side - Image */}
      <motion.div 
        className="flex-1 flex items-center justify-center relative overflow-visible min-h-[220px] sm:min-h-[250px] md:min-h-0 h-[70vh] sm:h-[60vh] md:h-[65vh] lg:h-[75vh]"
        initial={{ opacity: 0, x: 50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, delay: 0.2 }}
      >
        <img src="/hero.png" alt="Phone Mockup" className="w-auto h-[340px] sm:h-[420px] md:h-[540px] lg:h-[720px] max-h-full object-contain drop-shadow-xl" />
      </motion.div>
    </section>
  );
};
